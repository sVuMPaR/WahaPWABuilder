...
1. Откройте приложение → **Prepare offline** (на странице Factions или Rosters).
2. Выберите нужные армии и нажмите **Download selected** — или откройте каждую фракцию вручную в разделе **Factions**.
